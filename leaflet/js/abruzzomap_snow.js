    ...
    .then(arrayBuffer => {
      parseGeoraster(arrayBuffer).then(georaster => {
        ...
        */
        ...
        var overlayMaps = {'Snow cover (FSC)':sca, 'Tree cover':tcdlayer, 'Hillshade':hillshlayer, 'C.L.P.V. VA':avalanches_va, 'C.L.P.V. VF':avalanches_vf, 'Slope class':slopelayer, 'Ski Piste':pistelayer, 'User features':userFeatures};
