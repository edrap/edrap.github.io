$(document).ready(function () {
  ...
  //var osm_std = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  //  maxZoom: 16,
  //  maxNativeZoom: 18,
  //  minNativeZoom: 3,
  //  minZoom: 10,
  ...
  var osm_std = L.tileLayer('https://{s}.tile-cyclosm.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png', {
    maxZoom: 16,
    maxNativeZoom: 18,
    minNativeZoom: 3,
    minZoom: 10,
    ...
    .then(arrayBuffer => {
      parseGeoraster(arrayBuffer).then(georaster => {
        ...
        */
        ...
        var allMapLayers = {'lf':gpsFeatures, 'mpw':mapy_winter, 'osm':osm_std, '4um':baselayer2, 'otm':baselayer, 'gh':googleHybrid, 'tc':tcdlayer, 'hs':hillshlayer, 'sc':slopelayer, 'sa':sca, 'va':avalanches_va, 'vf':avalanches_vf, 'sp':pistelayer, 'uf':userFeatures, 'igm1':igm25k_min, 'igm2':igm25k_reg};
        ...
        var baseMaps = {'Mapy Winter':mapy_winter, 'CyclOSM':osm_std, '4UMaps':baselayer2, 'OpenTopoMap':baselayer, 'Google Hybrid':googleHybrid, 'IGM Italia':igm25k_min, 'IGM Abruzzo':igm25k_reg};
